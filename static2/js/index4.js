...
var PImgPlayer = {   
        ...
        init : function( objID, w, h, time ){   
                ...
                //   
                var ulStyle = "margin:0;width:"+w+"px;position:absolute;z-index:999;right:18px;FILTER:Alpha(Opacity=50,FinishOpacity=50, Style=1);overflow: hidden;bottom:10px;height:16px; border-right:1px solid #fff;";   
                //   
